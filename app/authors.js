...
$(function() {
	...
	var tableF = fastMakeTable("", authorsDistinquishFNSorted.length, 1, authorsDistinquishFNSorted, "1" );
	var tableL = fastMakeTable("", authorsDistinquishLNSorted.length, 1, authorsDistinquishLNSorted, "2");
